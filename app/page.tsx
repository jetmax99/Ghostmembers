...
export default function GhostGangUnified() {
  ...
  const allMembers = [
    {
      id: 1,
      name: "Hunter castellano",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/hunter.castellano.2025?locale=th_TH",
    },
    {
      id: 2,
      name: "Nampunch Rubmaidai",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/nong.grace.954672?locale=th_TH",
    },
    {
      id: 3,
      name: "Bank Whatisluv",
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/elle.whatisluv?locale=th_TH",
    },
    {
      id: 4,
      name: "Semi Gardos",
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=61587489156557&locale=th_TH",
    },
    {
      id: 5,
      name: "Razer Pentagram",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=61578682112163&locale=th_TH",
    },
    {
      id: 6,
      name: "Cartier Layla",
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=100025885462092&locale=th_TH",
    },
    {
      id: 7,
      name: "MeePhu Satxnic",
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/meephu.satxnic?locale=th_TH",
    },
    {
      id: 8,
      name: "Saka Readyplus",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-900/30",
      fb: "https://web.facebook.com/saka.readyplus?locale=th_TH",
    },
    {
      id: 9,
      name: "Mindbabe Ygz",
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/babebee.bebe?locale=th_TH",
    },
    {
      id: 10,
      name: "Thingthing Hologram",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=61579514684476&locale=th_TH",
    },
    {
      id: 11,
      name: "EMPTY SLOT",
    ...
    {
      id: 12,
      name: "Jxck Dernyoungsay",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=61584726548593&locale=th_TH",
    },
    {
      id: 13,
      name: "Leo Payamarn",
      ...
      group: "GHOST GANG",
      color: "border-gray-900/30",
      fb: "https://web.facebook.com/profile.php?id=61579549214581&locale=th_TH",
    },
    {
      id: 14,
      name: "Billy Diabalito",
      role: "MEMBER",
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/profile.php?id=61584032180777&locale=th_TH",
    },
    {
      id: 15,
      name: "Coco Ghost",
    ...
    },
    {
      ...
      group: "GHOST GANG",
      color: "border-gray-700",
      fb: "https://web.facebook.com/tonaor.orapirn?locale=th_TH",
    },
    {
      id: 17,
      name: "EMPTY SLOT",
